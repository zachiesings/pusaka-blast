# Panduan TestFlight — Pusaka Blast

Bundle ID `id.pusakablast.pusakablast` **sudah didaftarkan** (via ASC API), jadi
...
5. **Bundle ID:** pilih `id.pusakablast.pusakablast` (sudah ada di daftar)
6. **SKU:** bebas, mis. `pusakablast001`
...
2. **Add application → GitHub →** pilih repo `zachiesings/pusaka-blast`.
