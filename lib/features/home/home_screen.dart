...
/// Premium profile header — a level ring (from total stars) + title + coins.
class _LevelHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Palette.maroon.withOpacity(0.45), Palette.panel.withOpacity(0.9)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(24),
        border: Border.all(color: Palette.gold.withOpacity(0.4)),
        boxShadow: Palette.glow(Palette.maroon, blur: 24, a: 0.25),
      ),
      child: Row(
        children: [
          SizedBox(
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Empu Batik', style: Typo.title.copyWith(color: Palette.cream, fontSize: 16)),
                Text('Tingkat $level • ${5 - into} bintang ke tingkat ${level + 1}',
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Palette.panel.withOpacity(0.85),
