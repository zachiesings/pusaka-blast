...
/// and breaking into a happy hop every so often. Pure code, no assets.
///
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, c) {
        ...
        // a brisk walk bob (and a tiny forward lean as it steps)
        final bob = math.sin(_t * 7).abs() * widget.size * 0.05;

        // every lap, pause near an edge for a happy hop
